        ...
        <div className='footer'>
            ...
            <div className='socialMedia'>
                ...
                <div className='socialMediaIcons'>
                    ...
                    <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
            ...
            <div className='contactInfo'>
                <h2>Contact Us</h2>
                <ul>
                    <li>Email: apuestasbet@gmail.com</li>
